# -*- coding: utf-8 -*-
"""
Created on Mon Jan  2 17:39:06 2023
...
filePath = "/home/muhlabws4/Masaüstü/tkd_data/a4"  
#filePath = r'D:\bilimsel\veri\fosil\6_class'
...
#classes = to_categorical(classes,  num_classes=3)
rnd_seed = 116
np.random.seed(117)
...
for train_index, test_index in kf.split(features,classes): 
    ...
    print('Train... Model')
    model.fit(x_train , y_train, epochs=10, batch_size=8, validation_data=(x_val,y_val),verbose=2,callbacks=[checkpoint])
